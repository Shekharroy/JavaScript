...
admin_Messages = {
	...
	admin_passwordformat:"Please enter password between 8 to 20 characters. Password should contain atleast one uppercase alphabet, one lowercase alphabet, one digit, one special character from ~!@$%^&()_-#?.*{}|':\";=+`",
	...
	admin_requestallocateuserexeeds:"Maximum number of users limit reached. To increase the number of users, please send request to contact@dcirrus.com with your corporate id",
