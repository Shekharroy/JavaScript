...
function checkCorporateDomainService(lawfirmid){
	var type = "GET";
	var posturl = "https://vdr.dcirrus.io/api.acms.server/v1/lawfirm/server/<LAWFIRMID>/<ACTION>";
	//var posturl = "http://localhost/api.acms.server/v1/lawfirm/server/<LAWFIRMID>/<ACTION>";
